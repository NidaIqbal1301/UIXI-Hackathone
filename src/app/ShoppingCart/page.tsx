...
const Cart = () => {
  return (
    <><Header />
    <div>
      <div className="bg-[#F9F9F9] font-Clash Display w-full px-4 sm:px-10 lg:px-40 pt-10 pb-16 h-auto text-custom-purple">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-10">
          ...
          <div className="border-2 p-4">
            <h1 className="text-lg font-Clash Display">Product</h1>
          ...
          <div className="border-2 p-4 sm:hidden lg:block">
            ...
            <p className="mt-40 text-lg font-medium">£125</p>
          </div>
        </div>
        ...
        <div className="mt-10 text-center lg:text-right">
          ...
          <h1 className="inline text-xl sm:text-2xl font-semibold text-[#2A254B]">£210</h1>
          <p className="text-[#2A254B] text-sm mt-4">
