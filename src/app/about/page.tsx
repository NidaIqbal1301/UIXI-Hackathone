      ...
      <div className="flex flex-col md:flex-row w-full h-auto items-center px-4 py-16 space-y-8 md:space-y-0">
        ...
        <div className="border-2 bg-[#F9F9F9] w-full md:w-3/6 p-8 md:p-20">
          ...
          <p className="text-[#505977] py-6">
            ...
            <p className="text-[#505977]"> Handmade, and lovingly crafted furniture and homeware is what we live,
             breathe, and design so our Chelsea boutique became the hotbed for the 
             London interior design community.
          </p>
          <div className="my-10">
          <button className="bg-[#FFFFFF] h-12 w-40 rounded-sm text-[#2A254B]">Get in Touch</button>
          </div>
        </div>
      </div>
